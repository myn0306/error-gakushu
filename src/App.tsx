      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <header className="relative bg-white/80 backdrop-blur-md rounded-[32px] border-3 border-[#ffd3e0] p-6 sm:p-8 shadow-[0_6px_20px_rgba(150,120,100,0.12)] mb-8 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left space-y-2">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[#ffd3e0] border border-[#ff9db8] text-[#ff9db8] hover:bg-[#ffd3e0] transition-colors cursor-pointer shadow-xs"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[#e8f4fb] border border-[#cfe9f7] text-[#2b7ea8] hover:bg-[#cfe9f7] transition-colors cursor-pointer shadow-xs"
                >
                  <BookOpen size={12} />
                  <span>ぷち用語じてん 🌿</span>
                </button>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#5a4a42] tracking-tight flex items-center justify-center md:justify-start gap-2">
                <span className="whitespace-nowrap">エラー読み方ずかん</span>
            ...
            >
              <Mascot
                mood={currentUsako.mood}
                size="lg"
                bubbleText={currentUsako.text}
              />
